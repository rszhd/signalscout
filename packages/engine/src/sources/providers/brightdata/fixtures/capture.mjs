 ...
 *
 *     node packages/pipeline/src/sources/providers/brightdata/fixtures/capture.mjs
 *     node packages/pipeline/src/sources/providers/brightdata/fixtures/capture.mjs --only=comments
 *
...
writeFileSync(
  ...
  `${JSON.stringify(
    {
      capturedBy: "packages/pipeline/src/sources/providers/brightdata/fixtures/capture.mjs",
